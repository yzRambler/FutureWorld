...
namespace FW
{
	...
	public:
		...
		//typedef TIter<VTANISTACK> ANISTACK_ITER;
	...
	public:
		...
		//VTBNTK& vtBAT() { return m_vtBoneAniUnit; }
	...
	private:
		...
		//bool ObtainAnimations(FbxScene* pScene, FbxNode* pRootNode);
