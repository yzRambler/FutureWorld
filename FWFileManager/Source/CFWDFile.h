...
#pragma pack()
    ...
    //inline extern char* CloneStr(char** ppTargetBuf, char* pSrcBuf, int len);
    ...
    //inline extern void ReleaseStr(char* pBuf);
...
//#ifdef FW_EDITOR
	...
	public:
		...
		//FDWORD WriteAnimationData(CBone* pRootBoneTree, CAnimationGroup* pAniGroup);
