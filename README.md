...
The demoe running in Internet can be found in my website: www.spaceyz.org. (www.spaceyz.org/horseAni.html) You can check the loading flow of all assets by Browser's console. 
